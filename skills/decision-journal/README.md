...
every decision pins _what you knew when you made it_, and everything you learn afterward is **appended**,
...
- **`decide`** — at the moment of choosing, it resolves your view _now_ and pins one signed record of the
...
2. **How did my past decisions turn out?** — the confidence you recorded _then_ against the outcomes you
   appended _later_. Over- and under-confidence become visible.
...
node ([src/mcp-http.ts](../../src/mcp-http.ts)), set before load:
